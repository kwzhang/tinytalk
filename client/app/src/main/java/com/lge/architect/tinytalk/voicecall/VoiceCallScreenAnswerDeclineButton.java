...
public class VoiceCallScreenAnswerDeclineButton extends LinearLayout implements View.OnTouchListener {
  ...
  private static final String TAG = VoiceCallScreenAnswerDeclineButton.class.getSimpleName();
  ...
  public VoiceCallScreenAnswerDeclineButton(Context context) {
    super(context);
    initialize();
  }

  public VoiceCallScreenAnswerDeclineButton(Context context, @Nullable AttributeSet attrs) {
    super(context, attrs);
    initialize();
  }

  public VoiceCallScreenAnswerDeclineButton(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
