...
public class VoiceCallScreenActivity extends AppCompatActivity {
  ...
  public static final String ANSWER_ACTION   = VoiceCallScreenActivity.class.getCanonicalName() + ".ANSWER_ACTION";
  public static final String DENY_ACTION     = VoiceCallScreenActivity.class.getCanonicalName() + ".DENY_ACTION";
  public static final String END_CALL_ACTION = VoiceCallScreenActivity.class.getCanonicalName() + ".END_CALL_ACTION";
