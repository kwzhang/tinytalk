...
public abstract class UserApiService {
    ...
    public abstract Response resetPassword(String xPhoneNumber,CreditCard creditCard,SecurityContext securityContext) throws NotFoundException;
    ...
    public abstract Response getUser(String xPhoneNumber,String xPassword,SecurityContext securityContext) throws NotFoundException;
}
